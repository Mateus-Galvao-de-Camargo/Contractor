...
import com.golden.contractor.repository.VagaRepository;
import com.golden.contractor.repository.CandidatoRepository;
...
public class VagaController {
    ...
    public String updateVaga(@Valid Vaga vagaEditada, long codigo, RedirectAttributes attributes) {
        Vaga vaga = vr.findByCodigo(codigo);

        vaga.setData(vagaEditada.getData());
        vaga.setDescricao(vagaEditada.getDescricao());
        vaga.setNome(vagaEditada.getNome());
        vaga.setSalario(vagaEditada.getSalario());
        vr.save(vaga);

        attributes.addFlashAttribute("success", "Vaga alterada com sucesso!");

        String codigoEmString = "" + codigo;
        return "redirect:/" + codigoEmString;
    }
